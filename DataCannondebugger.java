/*
List<Opportunity> opps = [SELECT id FROM Opportunity WHERE id != '0061I000002KPgW'];
List<SBQQ__Quote__c> quotes = [SELECT id FROM SBQQ__Quote__c WHERE id != 'a0l1I000001Nzt4'];

delete quotes;
delete opps;
*/

String quoteId = 'a0l1I000001Nzt4';
Date startDate = Date.newInstance(2016, 5, 15);
Date endDate = Date.newInstance(2018, 10, 31);
Integer numRecords = 500;
Decimal avgDisc = 0.15;
...
ID batchProcessID = Database.executeBatch(new qLineBlaster(masterLines, qInsertIds, avgDisc));
